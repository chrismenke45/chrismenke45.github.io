const twitterClone = {
    ...
    experience: 'This app had a lot go into it.  It allowed me to practice developing and testing a separate back end and front end with the goal of bringing them together.  It also gave me the chance to write some responsive CSS to make it mobile friendly',
